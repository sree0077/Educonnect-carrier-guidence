...
import { ArrowRight, GraduationCap, School, BookOpen, Award, Users } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 text-center md:text-left animate-fade-in">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-lg">
                Your path to the perfect educational journey. Discover programs that align with your skills and interests.
              </p>
      ...
      <div className="py-16 bg-purple-600 text-white text-center">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <Link to="/login">
              <Button size="lg" variant="link" className="text-white underline hover:text-purple-100">
                Sign In
              </Button>
            </Link>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Connecting students with the right educational opportunities
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
            <p>© {new Date().getFullYear()} Career Guidance Platform. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
